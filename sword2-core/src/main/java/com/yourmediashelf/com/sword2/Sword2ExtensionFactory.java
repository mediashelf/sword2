...
public final class Sword2ExtensionFactory extends AbstractExtensionFactory implements Sword2Constants {

    public Sword2ExtensionFactory() {
        super(SWORD_TERMS_NS);
